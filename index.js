...
function setAlarm() {
    ...
    if (time.getHours() == wake) {
        ...
        document.getElementById("imgM").src = "goodMorning.jpeg"
    ...
    if (time.getHours() == lunch) {
        ...
        document.getElementById("imgM").src = "goodAfter.jpeg"
        document.getElementById("imgM").style.borderRadius = "2vw"
    ...
    if (time.getHours() == nap) {
        ...
        document.getElementById("imgM").src = "goodEvening.jpeg"
        document.getElementById("imgM").style.borderRadius = "2vw"
    }
    ...
    document.getElementById("wakeT").innerText = int();
